<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('admin/mine*') ? 'active' : '' }}">
            <a href="{{ url('admin/mine') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Mine</div>
            </a>
        </li>
        <li class="menu-item {{ request()->is('admin/driver*') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ request()->is('admin/vehicle*') ? 'active' : '' }}">
            <a href="{{ url('admin/vehicle') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
        ...
        <li class="menu-item {{ request()->is('admin/booking*') ? 'active' : '' }}">
            <a href="{{ url('admin/booking') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Vehicle Booking</div>
            </a>
        </li>
